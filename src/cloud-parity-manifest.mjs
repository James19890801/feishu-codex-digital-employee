...
export const CLOUD_PARITY_CONFIG_KEYS = Object.freeze([
  ...
  'feishuEnabled', 'wecomEnabled',
  'geweDailyBriefingGroupId', 'geweDailyBriefingGroupName',
  ...
  'geweMomentsPublisherEnabled', 'geweMomentsPublisherIntervalMs',
  'geweMomentsPublisherMorningWindow', 'geweMomentsPublisherEveningWindow',
  'geweMomentsScanIntervalMs', 'geweNewcomerWelcomeEnabled',
  'geweNewcomerWelcomeGroupId', 'geweNewcomerWelcomeGroupName',
  'geweNewcomerWelcomeIntervalMs',
