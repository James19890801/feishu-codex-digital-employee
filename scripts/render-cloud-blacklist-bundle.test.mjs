...
assert.equal(bundle.AIPROS_OWNER_OPEN_DINGTALK_ID, 'owner-open-id');
...
await writeFile(configPath, JSON.stringify({ automaticCommunicationBlocklist: [] }));
await assert.rejects(
  renderCloudBlacklistBundle({ configPath, outputPath }),
  /dingtalkOwnerOpenId/i,
);
