...
- SHA-256：`4e54a759ca403839c29e5607ece4c3dff3354e22b7e6c2ab2c79f2478729b01c`
- Payload 文件数：99
- Payload 字节数：854009
...
6. 最终 ZIP 解压后，`SHA256SUMS` 中 99 个 payload 文件全部校验为 `OK`。
7. 最终解压目录二次隐私扫描：`ok=true`，违规 0。
...
- 未修改当前机器的真实 LaunchAgent；隔离验收使用可审计的 launchctl stub。
