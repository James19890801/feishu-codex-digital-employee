...
</style></head><body><main class="wrap ${tone}"><div class="eyebrow">AIPR0S · LOCAL FIRST · CLOUDFLARE + RAILWAY</div><h1>云端兜底控制台</h1><p class="sub">本地为主，Railway 待机；Qoder Cloud Agent 处理经过脱敏的 L0/L1 文本，图片先经 Cloudflare 视觉识别。</p>
