...
assert.equal(translate('en', 'learningTitle'), 'Daily learning');
assert.equal(translate('zh', 'learningTitle'), '每日自学习');
assert.equal(translate('en', 'learnNow'), 'Learn now');
assert.equal(translate('zh', 'learnNow'), '立即学习');
